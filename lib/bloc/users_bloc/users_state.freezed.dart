...
mixin _$UsersState {
  ...
  Set<int> get selectedUser => throw _privateConstructorUsedError;
...
abstract class $UsersStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<User>? users, Set<int> selectedUser});
}
...
class _$_UsersState implements _UsersState {
  const _$_UsersState(
      {final List<User>? users, final Set<int> selectedUser = const {}})
      : _users = users,
  ...
  final Set<int> _selectedUser;
  @override
  @JsonKey()
  Set<int> get selectedUser {
  ...
  @override
  String toString() {
    return 'UsersState(users: $users, selectedUser: $selectedUser)';
  }
...
abstract class _UsersState implements UsersState {
  const factory _UsersState(
      {final List<User>? users, final Set<int> selectedUser}) = _$_UsersState;
